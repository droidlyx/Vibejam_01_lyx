...
/* 开局那次真的挂了：数组元素裸奔（"hook": ["第一句", 第二句]） */
t('数组元素裸奔',           '{"hook":["第一句", 第二句, "第三句"],"a":1}',
                                                                      o => o.hook.length === 3 && o.hook[1] === '第二句');
t('数组第一个就裸',         '{"hook":[第一句,"第二句"],"a":1}',        o => o.hook[0] === '第一句');
t('数组里带标点的裸值',     '{"h":["甲", 乙说：好。丙没答, "丁"]}',     o => o.h[1].includes('乙说'));
t('数字数组不要动',         '{"a":[1,2,3],"b":[-1,2.5]}',              o => o.a[2] === 3 && o.b[0] === -1);
t('嵌套数组不要动',         '{"a":[{"b":1},["x","y"]],"c":1}',         o => o.a[1][1] === 'y');
t('空数组不要动',           '{"a":[],"b":[[]],"c":1}',                 o => o.a.length === 0 && o.c === 1);

/* 开局那次也真的挂了：一个完整对象后面还跟着东西 */
t('后面又起一个对象',       '{"a":1,"b":"x"}{"a":2}',                  o => o.a === 1);
t('后面跟了两句人话',       '{"a":1}\n以上就是这一局的设定。',           o => o.a === 1);
t('前面有 ```json 围栏',    '```json\n{"a":1,"b":2}\n```',             o => o.b === 2);
t('尾巴里带引号也不怕',     '{"a":"x"} 然后他说"好"',                   o => o.a === 'x');
t('对象里的 } 不算数',      '{"a":"右括号 } 在字符串里","b":1}',        o => o.b === 1);
