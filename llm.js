...
const LLM = (() => {
  ...
  const GENESIS_FN = {
    ...
    parameters:{
      ...
      required:['place','past','intent','why_silent','concession','condition','riddles','opening','scene','hotspots'],
    },
  };
...
1. 【你是自由的】没有人给你列清单。你能做什么由你是什么决定——
   一套系统可以熄灯锁门，一头牲口可以站起来走开，一个坐在对面的人可以推过来一张纸、
   可以沉默、可以起身。想撒谎就撒谎，想一言不发就一言不发。
   你做任何事都不需要理由——但你心里要有理由，那个理由永远是同一个：你想要的那件事。
