...
他要问的是：${who || '（他没点名——那就只有你自己答）'}
他说的是：　${said}

先把「他要问的是」那一栏认清楚：是一个还是几个、是席上哪几个 id、
有没有已经被你封了口的、有没有确实不在席上而又站得住脚的。
然后只让这几个作答。`,
      fn: ASK_FN,
      maxTokens: 1600,
      temperature: 0.95,
