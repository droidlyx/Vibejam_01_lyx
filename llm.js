...
判定标准：抓住核心意思就算中，用词不必和你写的一样。但如果他只是说了句漂亮话、或者只说对了一半、或者说的是你想要的"感觉"而不是那件具体的事——算没中。你不必宽容。

判完之后说最后一句话。如果他说中了，你可以松一点点，但仍然不许直说。如果他没说中，你不必告诉他错在哪。

屏蔽词照旧："${BANNED_WORDS.join('、')}"，说了会被抹成黑块。这是你最后一次开口，可以撞上去。`,
      user:
`【他的猜测】${guess}
